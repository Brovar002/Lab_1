...
import by.goncharov.compile.antlr.AntlrTestLexer;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            inputStream = CharStreams.fromString(obj.readFileAsString("src/main/resources/CodeSample.auf"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        converter.toJava(MyVisitor.code, Paths.get("src/test/java/by/goncharov/Test.java"));
        System.out.println(result);


        String className = "src/test/java/by/goncharov/AppTest.java";
